...
if (!exists("params")) {
   params <- rmarkdown::yaml_front_matter('~/Documents_Local/git/LEEF/additionalPackages/zenDep/inst/Assemble and Upload pre-processed data.qmd')$params
}
...
metadata_bib <- new_metadata_bib(
  ...
  creator = list(
    list( 
      name = "Romana Limberger",         
      affiliation = "University of Zurich", 
      orcid = "0000-0002-9421-7520"),
    list( 
      name = "Uriah Daugaard",          
      affiliation = "University of Zurich", 
      orcid = "0000-0003-4092-717X"),
    list( 
      name = "Rainer M. Krug",              
      affiliation = "University of Zurich", 
  ...
  contributor = list(
    list( 
      name = "Anubhav Gupta",             
      affiliation = "University of Zurich", 
      orcid = "0000-0001-7977-9747", 
      type = "DataCollector"
    ),
    list( 
      name = "Debra Zuppinger-Dingley", 
      affiliation = "University of Zurich", 
      orcid = "0000-0002-4573-0563", 
      type = "DataCollector"
    ),
    list( 
    ...
    list( 
      ...
      affiliation = "University of Zurich",
       orcid = "0000-0002-7724-1633", 
       type = "ProjectLeader" # << types TODO
    ), 
    list( 
      name = "Rainer M. Krug",              
      affiliation = "University of Zurich", 
      orcid = "0000-0002-7490-0066", 
      type = c("DataCurator", "DataManager")
    ),
    list( 
      name = "Romana Limberger",         
      affiliation = "University of Zurich", 
    ...
    list( 
      name = "Sofia J. van Moorsel",       
      affiliation = "University of Zurich", 
      orcid = "0000-0003-1947-8971", 
      type = "DataCollector"
    ),
    list( 
      name = "Uriah Daugaard",          
